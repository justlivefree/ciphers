...
class MD5:
    ...
    F1 = lambda obj, B, C, D: (B & C) | (~B & D)
    F2 = lambda obj, B, C, D: (B & D) | (~D & C)
    F3 = lambda obj, B, C, D: B ^ C ^ D
    F4 = lambda obj, B, C, D: C ^ (B | ~D)

    keys: tuple[int, ...] = (0xd76aa478, 0xe8c7b756, 0x242070db, 0xc1bdceee,
